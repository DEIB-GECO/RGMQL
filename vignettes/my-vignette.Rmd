...
exon_res = sort(exon3, TRUE, list(DESC("exon_count")))
```
...
```
by default *materialize()* has R workig directoy as stored path.  
...
```{r, initialize remote, eval = FALSE}
