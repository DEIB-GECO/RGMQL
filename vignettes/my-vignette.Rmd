...
# Export the GRangesList as GMQL dataset at destination path
...
If *regions* is not specified, only the fundamental elements of GRanges 
are extracted, i.e., the genomic coordinates.
Note that this function works only if every sample in dataset includes the same 
number of regions with the same coordinates.
