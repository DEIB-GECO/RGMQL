...
#' In this case DLE: denotes the less distance clause, which selects all 
#' the regions of the experiment such
#' that their distance from the anchor region is less than, or equal to, 
#' 'value' bases.
#' 
...
#' @return None
#' 
#' @seealso \code{\link{DGE}} \code{\link{DLE}} \code{\link{DG}} 
#' \code{\link{MD}} \code{\link{DOWN}} \code{\link{UP}} 
#' 
#' @examples
#' 
...
#' to be used in GMQL functions that use genometric predicate parameter
#' requiring distal condition on value
#' In this case DLE: denotes the great distance clause, which selects all 
#' the regions of the experiment such that their distance from the anchor 
#' region is less than, or equal to, 'value' bases.
#' 
#' @param value single string identifying distance between genomic regions 
#' in base pairs
#'
#' @return None
#' 
#' @seealso \code{\link{DGE}} \code{\link{DLE}} \code{\link{DL}} 
#' \code{\link{MD}} \code{\link{DOWN}} \code{\link{UP}} 
#' 
#' @examples
#' 
...
#' HM = read_dataset(test_path2)
#' join_data = join(TSS, HM, 
#' genometric_predicate = list(list(MD(1), DG(12))), c("provider"), 
#' region_output = "RIGHT")
#'
#' 
#' @export
...
#' to be used in GMQL functions that use genometric predicate parameter
#' requiring distal condition on value
#' In this case DLE: denotes the  less-equal distance clause, which selects 
#' all the regions of the experiment such that their distance from the anchor 
#' region is less than, or equal to, 'value' bases.
#' There are two special less-equal distances clauses: DLE(-1) searches 
#' for regions of the experiment which overlap with the anchor region 
#' (regardless the extent of the overlap),
#' while DLE(0) searched for experiment regions adjacent to, or overlapping, 
#' the anchor region
#' 
#' @param value string identifying distance between genomic regions 
#' in base pairs, 
...
#' @return None
#' 
#' @seealso \code{\link{DGE}} \code{\link{DL}} \code{\link{DG}} 
#' \code{\link{MD}} \code{\link{DOWN}} \code{\link{UP}} 
#' 
#' @examples
#' 
...
#' to be used in GMQL functions that use genometric predicate parameter
#' requiring distal condition on value
#' In this case DGE: denotes the greater-equal distance clause, which selects 
#' all the regions of the experiment such
#' that their distance from the anchor region is greater than, 
#' or equal to, 'value' bases.
#' 
#' @param value string identifying distance between genomic regions 
#' in base pairs, 
#'
#' @return None
#' 
#' @seealso \code{\link{DLE}} \code{\link{DG}} \code{\link{DL}} 
#' \code{\link{MD}} \code{\link{DOWN}} \code{\link{UP}} 
#' 
#' @examples
#' 
...
#' HM = read_dataset(test_path2)
#' join_data = join(TSS, HM, 
#' genometric_predicate = list(list(MD(1), DGE(120000))), c("provider"), 
#' region_output = "RIGHT")
#'
#' @export
#'
...
#' to be used in GMQL functions that use genometric predicate parameter
#' requiring distal condition on value
#' In this case MD: denotes the minimum distance clause, which selects 
#' the 'value' regions of the experiment at minimial distance from the 
#' anchor region.
#' When there are ties (regions at the same distance from the anchor region), 
#' regions of the experiment are kept in the result even 
#' if they exceed the 'value' limit.
#' 
#' @param value string identifying number of regions at minimum 
#' distance beetwen expertiment and anchor region  
#'
#' @return None
#' @seealso \code{\link{DGE}} \code{\link{DLE}} \code{\link{DG}} 
#' \code{\link{DL}} \code{\link{DOWN}} \code{\link{UP}} 
#' 
#' @examples
#' 
#' 
...
#' 
#' @seealso \code{\link{DGE}} \code{\link{DLE}} \code{\link{DG}} 
#' \code{\link{DL}} \code{\link{MD}} \code{\link{DOWN}} 
#' 
#' @examples
#' 
#'
...
#' HM = read_dataset(test_path2)
#' join_data = join(TSS, HM, 
#' genometric_predicate = list(list(MD(1), DGE(120000), UP())), c("provider"), 
#' region_output = "RIGHT")
#' 
#' @export
#'
...
#'
#' This class constructor is used to create instances of DISTAL object
#' to be used in GMQL functions \code{\link{join}} in genometric predicate 
#' parameter that require distal condition on value
...
#' 
#' @seealso \code{\link{DGE}} \code{\link{DLE}} \code{\link{DG}} 
#' \code{\link{DL}} \code{\link{MD}} \code{\link{UP}} 
#' 
#' @examples
#' 
#' 
