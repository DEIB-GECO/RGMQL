...
TFARMatrix <- function(GMQL_dataset_path, metadata = NULL,metadata_prefix = NULL, regions = NULL)
{
  ...
  {
    samples_file <- .check_metadata_files(metadata,metadata_prefix,gdm_meta_files)
...
#' @export
#'
TFARMemAtrix <- function(rangesList, metadata = NULL,metadata_prefix = NULL, regions = NULL)
{
