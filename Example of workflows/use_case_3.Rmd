...
#dataset_name <- '_20220105_160442_TF_rep_good_ordered' #specify the name of the already downloaded dataset
...
# Uncomment to load previously obtained results:
#setwd('./Results_use_case_3')
#dataset <- '_20220105_180300_TF_res' #specify the name of the already downloaded dataset
