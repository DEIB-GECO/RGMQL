...
```{r, echo=FALSE}  
# Uncomment to load previously obtained results, specifying the path until the downloaded folder:
#grl_mut_under_D <- import_gmql('./Results_use_case_1/_20220104_181132_geneMut_data_res_under65', TRUE)
